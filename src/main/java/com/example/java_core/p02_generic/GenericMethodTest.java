...
public class GenericMethodTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Max(Integer) of 5 and 6 is: " + GenericMethods.maximum(5, 6));
        System.out.println("Max(Double) of 5.1 and 5.0 is: " + GenericMethods.maximum(5.1, 5.0));
        System.out.println("Max(String) of qwe and asd is: " + GenericMethods.maximum("qwe", "asd"));

        System.out.println("\n--- testing collection with wildcard ---");
        List<Integer> list1 = Arrays.asList(1, 2, 3, 4, 5);
        System.out.println("Max element<Integer> val: " + GenericMethods.maxElement(list1));
...
class GenericMethods {  // class with generic methods
